...
<div class="region region-content">
    <section class="block block-system clearfix" id="block-system-main">
        <div class="ds-1col node node-accessory view-mode-full clearfix">
            <div class="field field-name-uc-product-image field-type-image field-label-hidden field-items field-item even"><img src="/sites/default/files/product/image/accessory/<?php print $image1 ;?>" /></div>
              ...
              <div class="field-description-section-wrapper">
                ...
                <div class="group-pricingac field-group-div" id="node_accessory_full_group_pricingac">
                    <div class="product-info sell-price">
                        <span class="uc-price-label">Price:</span> <span class="uc-price">$<?php print $display_price; ?></span><br />
                    </div>
...
<!-- Please do not modify below this line -->
            ...
            <div class="group-specifications-wrap field-group-div" id="node-accessory-full-group-specifications-wrap"> <?php  if (!empty($field_specifications[0]['safe_value'])){
