...
<div class="region region-content">
    <section class="block block-system clearfix" id="block-system-main">
        <div class="ds-1col node node-basic_phone view-mode-full clearfix">
            <div class="field field-name-uc-product-image field-type-image field-label-hidden field-items field-item even"><img src="/sites/default/files/product/image/phone/<?php print $image1 ;?>" /></div>
              ...
              <div class="field-description-section-wrapper">
                ...
                <div class="group-pricing field-group-div" id="node-basic_phone-full-group-pricing">
...
<!-- Please do not modify below this line -->
            ...
            <div class="group-specifications-wrap field-group-div" id="node-basic_phone-full-group-specifications-wrap"> <?php  if (!empty($field_specifications[0]['safe_value'])){
