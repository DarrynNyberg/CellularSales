...
<div class="region region-content">
    <section class="block block-system clearfix" id="block-system-main">
        <div class="ds-1col node node-tablet view-mode-full clearfix">
            <div class="field field-name-uc-product-image field-type-image field-label-hidden field-items field-item even"><img src="/sites/default/files/product/image/tablet/<?php print $image1 ;?>" /></div>
              ...
              <div class="field-description-section-wrapper">
                ...
                <div class="group-pricing field-group-div" id="node-tablet-full-group-pricing">
...
<!-- Please do not modify below this line -->                   
                 ...
                 <div class="big_box">
                        ...
                        print "<div class=\"box\">" ;
                        print "<img src=\"/sites/default/files/product/image/tablet/".$field_product_image_2[0]['filename']."\" style=\"float: left; \" class=\"img1\"/>";
...
<!-- Please do not modify below this line -->
            ...
            <div class="group-specifications-wrap field-group-div" id="node-tablet-full-group-specifications-wrap"> <?php  if (!empty($field_specifications[0]['safe_value'])){
...
<?php } elseif(!$page && $teaser) { ?>
    ...
    <div class="col-sm-6 product-catalog-display">
        <div class="row">
            <div class="col-sm-4">
                <div class="product-cat-tablet-img">
                    <img src="/sites/default/files/product/image/tablet/<?php print $image1 ;?>" />
                </div>
            </div>
            <div class="col-sm-8">
